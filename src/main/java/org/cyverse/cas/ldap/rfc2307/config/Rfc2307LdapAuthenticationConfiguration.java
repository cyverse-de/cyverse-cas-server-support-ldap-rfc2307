...
public class Rfc2307LdapAuthenticationConfiguration {
    ...
    @Autowired
    public GroupMembershipProperties getGroupMembershipProperties() {
        return groupMembershipProperties;
    }
    ...
    public Collection<AuthenticationHandler> ldapAuthenticationHandlers() {
        ...
        LOGGER.warn(casProperties.toString());
        casProperties.getAuthn().getLdap()
            ...
            .forEach(l -> {
                ...
                final LdapAuthenticationHandler handler = new Rfc2307LdapAuthenticationHandler(
                        l.getName(), servicesManager, ldapPrincipalFactory(), l.getOrder(),
                        authenticator, strategy, groupMembershipResolver);
